...
# Bazel v9.2 Multi-Language Monorepo Example
...
1. [ ] Development:
    ...
    - [x] Improve Bazel CLI output by intercepting BEP ([commit](https://github.com/tomsoir/bazel-monorepo/commit/dea1fbb9d9def0e61ad07def5eeac3bacb55b8c5))
